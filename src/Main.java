import gui.view.AddCustomerDialog;
...
//        }
        ...
        frame.setContentPane(new AddCustomerDialog().getContentPane());
        ...
        Dimension size = new Dimension(
                (int) (Constant.screenSize.getWidth() * 1 / 3),
                (int) (Constant.screenSize.getHeight() * 1/ 3));
        frame.setSize(size);
